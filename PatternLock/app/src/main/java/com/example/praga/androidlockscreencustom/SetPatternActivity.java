...
public class SetPatternActivity extends BasePatternAcitivity implements PatternView.OnPatternListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            if (patternString != null) {
                pattern = Util.stringToPattern(patternString);
            }
            updateStage(Stage.values()[savedInstanceState.getInt(KEY_STAGE)]);
        }

        Util.setActionBarDisplayUp(this);
    }
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        if (pattern != null) {
            outState.putString(KEY_PATTERN, Util.patternToString(pattern));
        }
    }
