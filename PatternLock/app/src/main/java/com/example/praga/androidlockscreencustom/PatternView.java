...
public class PatternView extends View {
    ...
    private void sendAccessEvent(int resId) {
        Util.announceForAccessibility(this, getContext().getString(resId));
    }
    ...
    protected Parcelable onSaveInstanceState() {
        ...
        return new SavedState(superState, Util.patternToString(mPattern), mPatternDisplayMode.ordinal(), mInputEnabled, mInStealthMode);
    }
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        ...
        setPattern(DisplayMode.Correct, Util.stringToPattern(ss.getSerializedPattern()));
    ...
    private final class PatternExploreByTouchHelper extends ExploreByTouchHelper {
        ...
        private CharSequence getTextForVirtualView(int virtualViewId) {
            return getResources().getString(R.string.pl_access_pattern_cell_added);
        }
